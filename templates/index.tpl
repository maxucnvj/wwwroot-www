...
<link href="{$sysinfo.statics}/css/index.css" rel="stylesheet" type="text/css" />
...
<div class="index-slide">
    <div id="myCarousel" class="carousel wrap">
      ...
      <div class="carousel-inner">
        <div class="active item" style="background:url({$sysinfo.statics}/images/_pic/slide-pic5.png) no-repeat 640px bottom;">
        ...
        <div class="item" style="background:url({$sysinfo.statics}/images/_pic/slide-pic4.png) no-repeat 50px bottom;">
        ...
        <div class="item" style="background:url({$sysinfo.statics}/images/_pic/slide-pic3.png) no-repeat 70px bottom;">
        ...
        <div class="item" style="background:url({$sysinfo.statics}/images/_pic/slide-pic2.png) no-repeat right bottom;">
        ...
        <div class="item" style="background:url({$sysinfo.statics}/images/_pic/slide-pic1.png) no-repeat 90px bottom;">
            <div class="bnr-box1 span6 pull-right">
                <h5>百年传承</h5>
                <h4>酿一村两年纯酿荫油</h4>
...
<div class="index-sort clearfix">
    {foreach from=$category key="i" item="v" name="cate"}
        {if $smarty.foreach.cate.index lt 8}
    	<div class="index-sort-item">
        	<img src="{$sysinfo.statics}/images/indx-s0{$i+1}.png">
            <a href="{'product|list'|geturl:'categoryid':$v.id}" class="cover">
...
<div class="index-sort2">
	<a href="{geturl('product|hot')}" class="index-sort2-a mr5"><i></i></a>
	<a href="{geturl('product|new')}" class="index-sort2-b mr5"><i></i></a>
	<a href="{geturl('product|bill')}" class="index-sort2-c"><i></i></a>
</div>
<div class="index-sort3">
	<div class="index-title">
    	<img src="{$sysinfo.statics}/images/indx-pic2.png">
    	<span class="bg-ff">精致生活</span><i></i>
    </div>
    <ul class="list">
        {foreach from=$category key="i" item="v" name="cate"}
        {if $smarty.foreach.cate.index gt 7}
        <li class="item">
            <div class="img"><span><i class="icon-{if $v.category_name eq '小支酒水'}wine{else if $v.category_name eq '海鲜干货'}fish{else if $v.category_name eq '营养保健'}leaf{else}break{/if}"></i></span></div>
            <h4>{$v.category_name}</h4>
            <p>{$v.info}</p>
            <a href="{'product|list'|geturl:'categoryid':$v.id}" class="btn btn-success">查看更多</a>
        </li>
        {/if}
    {/foreach}
    </ul>
...
<div class="index-sort4">
	<div class="wrap">
        <div class="index-title">
            <img src="{$sysinfo.statics}/images/indx-pic3.png">
            <span class="bg-f4">精品推荐</span><i></i>
        </div>
        <!--con start-->
        <div class="con"  id="masonry">
        	<div class="item">
            	<a href="#" title=""><img src="{$sysinfo.statics}/images/_pic/02.png"></a>
            ...
            <div class="item">
            	<a href="#" title=""><img src="{$sysinfo.statics}/images/_pic/slide-pic1.png"></a>
                <div class="good-item-detail clearfix">
        	...
        	<div class="item">
            	<a href="#" title=""><img src="{$sysinfo.statics}/images/_pic/01.png"></a>
                <div class="good-item-detail clearfix">
            ...
            <div class="item">
            	<a href="#" title=""><img src="{$sysinfo.statics}/images/_pic/03.png"></a>
                <div class="good-item-detail clearfix">
                	<h3><a href="#">商品名称商品名称商称商品名称</a></h3>
                    <p class="intr">商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍</p>
                    <div class="state clearfix">
...
<script src="{$sysinfo.statics}/static/masonry-docs.min.js"></script>
<script>
$(function() {
