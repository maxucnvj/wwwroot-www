<?php /* Smarty version Smarty-3.1.21, created on 2015-05-22 13:16:28
         compiled from ".\templates\getpass.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15784555c48dbcce850-88703166%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2bcc673e236e7735896ad45610463e046337200a' => 
    array (
      0 => '.\\templates\\getpass.tpl',
      1 => 1432275623,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15784555c48dbcce850-88703166',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21',
  'unifunc' => 'content_555c48dbd10ee3_86570815',
  'variables' => 
  array (
    'sysinfo' => 0,
    'backurl' => 0,
...
<?php if ($_valid && !is_callable('content_555c48dbd10ee3_86570815')) {function content_555c48dbd10ee3_86570815($_smarty_tpl) {?><!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<div class="bg-ec pt30 pb30">
  <div class="wrap">
    <div class="zc-title pl400 bgt-2">修改登录密码</div>
    <div class="zc-f pt40 pb40">
      <form>
        ...
        <div class="input-prepend">
        	...
        	<input class="span4" type="password" id="_password1" placeholder="请设置登陆密码" />
        </div>
        <div class="input-prepend">
        	<span class="add-on paw-cof"></span>
        	<input class="span4" type="password" id="_password2" placeholder="请确认登陆密码" />
        </div>
        密码长度至少6个字符，最多32个字符
...
$(function(){
    ...
    $('#_update').on('click',function(){
        ...
        //发送数据
        $.post('<?php echo geturl("login|changepassword");?>
',{
            "mobile":$('#_mobile').val(),
            "code":$('#_code').val(),
...
';
                if(backurl){
                    ...
                    location.href = "<?php echo geturl('login|run');?>
";
                }
                return;
            }else{
